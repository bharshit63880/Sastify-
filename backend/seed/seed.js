...
const buildProductsData = (categories, brands) => {
  ...
  categories.forEach((category, categoryIndex) => {
    ...
    for (let i = 0; i < PRODUCTS_PER_CATEGORY; i += 1) {
      ...
      const images = [image(pick(cfg.img, idx)), image(pick(cfg.img, idx + 1))];
